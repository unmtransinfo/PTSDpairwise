...
OhdsiRTools::checkUsagePackage("PTSDpairwise")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/PTSDpairwise.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PTSDpairwise.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "PTSDpairwise",
                                mode = "description",
